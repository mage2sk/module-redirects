<?php
/**
 * Standalone install + heartbeat reporter for Panth_Redirects.
 *
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_Redirects';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-redirects';
